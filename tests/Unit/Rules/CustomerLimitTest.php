...
use Armezit\GetCandy\VirtualProduct\Exceptions\CustomerQuantityLimitException;
use Armezit\GetCandy\VirtualProduct\Exceptions\CustomerTotalLimitException;
...
class CustomerLimitTest extends TestCase
{
    ...
    public function test_query_builder_is_correct()
    {
        ...
        $query = VirtualProduct::withoutTrashed()->where(function ($q) use ($cart) {
    ...
    public function test_collection_filter_is_correct()
    {
        ...
        $limits = VirtualProduct::withoutTrashed()->get();
    ...
    public function test_can_work_without_error_for_guest_cart()
    {
         ...
         */
        $query = VirtualProduct::withoutTrashed();
